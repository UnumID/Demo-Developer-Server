...
export class PresentationService {
  ...
  // async create (verificationResponse: VerificationPresentationResponse): Promise<VerificationPresentationResponse> {
  ...
  //   makeDemoPresentationDtoFromEntity = (entity: VerificationResponse): DemoPresentationDto => {
  //     const {
  //       uuid,
  //       createdAt,
  //       updatedAt,
